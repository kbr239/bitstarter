...
var buildfn = function(checks, outputJson) {
	...
	if (result instanceof Error) {
	    ...
	    $ = cheerio.load(result);
	    outputJson(checkHtmlFile($, checks));
	}
    };
    return urlCheck;
};
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url_address>', 'heroku url')
	.parse(process.argv);
    
    if(program.url) {
	 var urlCheck = buildfn(program.checks, outputJson);
